...
var _react = _interopRequireDefault(__webpack_require__(8290));
...
"use strict";
module.exports = require("/Users/iker/Documents/Pepita/web-psicologia/web-psicologo.worktrees/fix/deployment-styling-issues/.cache/ssr-builtin-trackers/fs");
...
const React=__webpack_require__(8290);const{grabMatchParams}=__webpack_require__(5870);const{StaticQueryContext}=__webpack_require__(123);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(9226);const{ServerLocation,Router}=__webpack_require__(6462);const{renderToString}=__webpack_require__(4700);const{parse}=__webpack_require__(6192);const styleToOjbect=__webpack_require__(9108);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
"use strict";
var _interopRequireDefault=__webpack_require__(4994);var _extends2=_interopRequireDefault(__webpack_require__(4634));var _react=_interopRequireDefault(__webpack_require__(8290));var _gatsby=__webpack_require__(123);var _internals=__webpack_require__(20);// TODO: remove for v3
...
var React = _interopRequireWildcard(__webpack_require__(8290));
...
var _react = __webpack_require__(8290);
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(2460),e=__webpack_require__(8290),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
"use strict";
module.exports = require("/Users/iker/Documents/Pepita/web-psicologia/web-psicologo.worktrees/fix/deployment-styling-issues/node_modules/react-dom/server.js");
...
"use strict";
var _interopRequireDefault=__webpack_require__(4994);var React=_interopRequireWildcard(__webpack_require__(8290));var _gatsby=__webpack_require__(123);var _common=__webpack_require__(1854);var _getManifestPathname=_interopRequireDefault(__webpack_require__(4598));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
 ...
 */const React=__webpack_require__(8290);/**
 * @type {import('gatsby').GatsbySSR['onRenderBody']}
 */exports.onRenderBody=({setHtmlAttributes,setHeadComponents})=>{setHtmlAttributes({lang:`es`});// Add Netlify Identity widget script
setHeadComponents([React.createElement("script",{key:"netlify-identity-widget",src:"https://identity.netlify.com/v1/netlify-identity-widget.js"})]);};
...
"use strict";
module.exports = require("/Users/iker/Documents/Pepita/web-psicologia/web-psicologo.worktrees/fix/deployment-styling-issues/.cache/ssr-builtin-trackers/https");
...
exports.components={"component---src-pages-404-js":()=>__webpack_require__.e(/* import() | component---src-pages-404-js */ 125).then(__webpack_require__.bind(__webpack_require__, 3331)),"component---src-pages-admin-index-js":()=>Promise.all(/* import() | component---src-pages-admin-index-js */[__webpack_require__.e(255), __webpack_require__.e(791)]).then(__webpack_require__.bind(__webpack_require__, 7101)),"component---src-pages-blog-index-js":()=>__webpack_require__.e(/* import() | component---src-pages-blog-index-js */ 334).then(__webpack_require__.bind(__webpack_require__, 6604)),"component---src-pages-index-js":()=>Promise.all(/* import() | component---src-pages-index-js */[__webpack_require__.e(255), __webpack_require__.e(661), __webpack_require__.e(293)]).then(__webpack_require__.bind(__webpack_require__, 9064)),"component---src-pages-using-typescript-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-using-typescript-tsx */ 743).then(__webpack_require__.bind(__webpack_require__, 3479))};
...
"use strict";
module.exports = require("/Users/iker/Documents/Pepita/web-psicologia/web-psicologo.worktrees/fix/deployment-styling-issues/.cache/ssr-builtin-trackers/http");
...
"use strict";
module.exports = require("/Users/iker/Documents/Pepita/web-psicologia/web-psicologo.worktrees/fix/deployment-styling-issues/node_modules/react/index.js");
...
/******/ 			return "" + ({"125":"component---src-pages-404-js","293":"component---src-pages-index-js","334":"component---src-pages-blog-index-js","743":"component---src-pages-using-typescript-tsx","791":"component---src-pages-admin-index-js"}[chunkId] || chunkId) + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
const React=__webpack_require__(8290);const path=__webpack_require__(2003);const{renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(4700);const{ServerLocation,Router,isRedirect}=__webpack_require__(6462);const merge=__webpack_require__(4744);const{StaticQueryContext}=__webpack_require__(123);const fs=__webpack_require__(905);const{WritableAsPromise}=__webpack_require__(7227);const{RouteAnnouncerProps}=__webpack_require__(6858);const{apiRunner,apiRunnerAsync}=__webpack_require__(9432);const asyncRequires=__webpack_require__(6877);const{version:gatsbyVersion}=__webpack_require__(5818);const{grabMatchParams}=__webpack_require__(5870);const{headHandlerForSSR}=__webpack_require__(988);const{SlicesResultsContext,SlicesContext,SlicesMapContext,SlicesPropsContext}=__webpack_require__(2024);const{ServerSliceRenderer}=__webpack_require__(8455);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
